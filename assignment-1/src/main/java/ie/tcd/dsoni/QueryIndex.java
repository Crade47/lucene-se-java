...
class QueryIndex {
    ...
    public QueryIndex(String path, Analyzer analyzer, Similarity similarity, String type) {
        try {
            ...
            System.out.println("error with query index method in");
            e.printStackTrace();
        }
    }
    ...
    public void parseCorpus(String path) throws IOException {
        ...
        System.out.println("parsing with path: " + path);
        ...
        System.out.println("finished parsing corpus with path: " + path +" --->");
    }
    ...
    public void queryIndexFromQueries(Analyzer analyzer, Similarity similarity) throws IOException, ParseException {
		...
		DirectoryReader dreaderobj = DirectoryReader.open(directory);
		IndexSearcher isearcher = new IndexSearcher(dreaderobj);
        ...
        for (CranQuery cranQuery: getQueries()) {
            ...
            System.out.println("query " + cranQuery.getId() + " complete");
    ...
    public void saveToFile() throws IOException {
        ...
        printWriter.close();
        System.out.println("for results go to: " + filePath);
    }
